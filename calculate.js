...
function updateDisplay() {
        ...
        и помещаю этот объект в переменную displayElement */
        displayElement.textContent = currentDisplay;
        /* с помощью метода text.Content текстовому содержимому элемента из переменной displayElement присваиваю
        текущее значение переменной currentDisplay */
}

// Вычисление результата опреации и вывод его в дисплей
function calculateResult() {
        // использую конструкцию try ... catch для отлавливания ситуации с ошибочно введёнными с клавиатуры калькулятора
...
function clearLastElement() {
        ...
        // индексы (0, -1) указывают, что будут взяты символы с первого (индекс 0) и до последнего (индекс -1), не включая последний;
